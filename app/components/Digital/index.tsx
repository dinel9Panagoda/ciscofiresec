...
const Digital = () => {
    return (
        ...
        <div className="mx-2">
            <div className='mx-auto max-w-7xl px-4 my-40 pb-20 lg:pb-40 lg:px-8 rounded-3xl bg-orangered relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div>
                        <div className="girldoodle">
                            <Image src="/images/digital/whoWeAre.png" alt="girldoodle" className="" width={815} height={691} />
                        </div>
                    </div>
