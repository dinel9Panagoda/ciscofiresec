...
const postData: DataType[] = [
    {
        imgSrc: '/images/services/videointercom/VI1.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI2.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI3.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI4.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI5.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI6.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI7.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI8.jpeg'
    },
    {
        imgSrc: '/images/services/videointercom/VI9.jpeg'
    }
]
...
return (
    <section className=''>
        ...
        {/* <div className=''> */}
        <div className='mb-32'>
            <img className='w-full' src='/images/services/videointercom/VideoIntercomMainBanner.png' />

        </div>

        <div className='grid sm:grid-cols-2 gap-7 px-10 max-w-7xl mx-auto'>
            <div>
                <img src='/images/services/videointercom/HomeVideoIntrecom.png' alt="Video Intercom" className="inline-block rounded-3xl w-full"  />
            </div>
            <div className='text-justify'>
                <img className='inline-block w-auto pb-10' src='/images/services/videointercom/VIDEO_INTERCOM.GIF' /><br />
        ...
        <div className='specialOfferSideBar'>
                    ...
                    <div className=' relative w-40 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl bg-white p-3' src='/images/services/videointercom/SpecialOfferVI.gif' />
                        </div>
        ...
        <Modal
                        ...
                        <div className='grid md:grid-cols-2'>
                            ...
                            <div onClick={handleClose} className='absolute top-5 right-5 text-white font-bold cursor-pointer'>X</div>
                                <div className='absolute -left-12 -top-12 p-3 bg-white w-fit rounded-full border-2 border-blue  drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]'>
                                 <img src='/images/services/videointercom/SpecialOfferVI.gif' className='w-20' />
                                </div>
                                <h1 className='uppercase font-black text-3xl py-10 text-white'>Special Offer!</h1>

                                <p className=''><span className='font-bold bg-lightblue px-5 py-1 rounded-full border-2 border-navyblue text-navyblue text-sm'>Stay Safe & Save Big!</span> <br/> <br/> <span className=' text-white px-5'>Limited Time Discounts on Essential Video Intercom Equipment!</span></p>
                ...
                {/* <Modal
                        ...
                        onClose={handleClose}
                        disableAutoFocus={true}
                        className="absolute w-fit h-fit w-fit m-auto text-center"
                    >

                        <div className='grid sm:grid-cols-2'>
                            <div className='bg-white rounded-l-3xl'>
                                <img className='w-96' src='/images/services/firealarms/SpecialOfferPopUp.gif' alt='Special Offer' />    
                            </div>
                            <div className='bg-blue rounded-r-3xl relative w-96'>
                                <div className='absolute -left-12 -top-12 p-3 bg-white w-fit rounded-full border-2 border-blue  drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]'>
                                <img src='/images/services/videointercom/SpecialOfferVI.gif' className='w-20' />
                                </div>
                                <h1 className='uppercase font-black text-3xl py-10 text-white'>Special Offer!</h1>

                                <p className=''><span className='font-bold bg-lightblue px-5 py-1 rounded-full border-2 border-navyblue text-navyblue text-sm'>Stay Safe & Save Big!</span> <br/> <br/> <span className=' text-white'>Limited Time Discounts on Essential Video Intercom Equipment!</span></p>
                                <div className='mt-10 mx-auto bg-white w-fit py-5 px-10 rounded-full text-blue border-2 mb-5 border-darkblue drop-shadow-[0_3px_3px_rgba(0,0,0,0.8)]'>
                                    <span className='text-7xl font-black'>30%</span>
                                    <span className='ml-4'>OFF</span>
                                </div>
        ...
        <h6 className='text-red text-center pb-5 font-bold text-3xl'>Recent Video Intercom Units We Did For Our Clients...</h6>
