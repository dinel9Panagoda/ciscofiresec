...
const Buildings = () => {
    ...
    return (
        ...
        <section className=''>
            ...
            <div className='bg-fabuilding_banner grid md:grid-cols-3 h-screen'>
                <div className='my-auto ml-10 w-full col-span-2'>
                    ...
                    <h1 className='md:text-7xl sm:text-5xl text-3xl text-white font-bold'>
                        <span className='Wittgenstein drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Fire Alarms in <span className='text-blue font-black'>Buildings</span></span> 
                ...
                <div className='md:grid md:justify-items-stretch'>
                    <div onClick={handleOpen} className='justify-self-end cursor-pointer mt-10 mr-10 ml-5'>
                        ...
                        <div className=' relative w-80 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                            ...
                            <img className='w-80 rounded-3xl' src='/images/services/firealarms/SpecialOfferFABuilding.png' />
                        </div>
...
<div className="grid sm:grid-cols-2 gap-1 pt-10">
    <div className="grid gap-1">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building7.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building2.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building3.jpeg" alt="" />
        </div>

    </div>
    <div className="grid gap-1">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building4.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building5.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Building6.jpeg" alt="" />
        </div> 
    </div>
