    ...
    return (
        <section className=''>
            ...
            <div className=' relative bg-grey sm:py-32 py-20 sm:pl-10 pl-5'>
                ...
                <span className='drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Fire Alarms in Warehouses:</span> Ensuring Safety for All
            </h1>
            </div>
