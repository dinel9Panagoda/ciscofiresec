...
const Warehouses = () => {
    ...
    return (
        ...
        <section className=''>
            <div className='bg-fawarehouse_banner grid md:grid-cols-3 h-screen'>
                <div className='my-auto ml-10 w-full col-span-2'>
                    ...
                    <h1 className='md:text-7xl sm:text-5xl text-3xl text-white font-bold'>
                        <span className='Wittgenstein drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Fire Alarms in <span className='text-green font-black'>Warehouses</span></span> 
                ...
                <div className='md:grid md:justify-items-stretch'>
                    ...
                    <div className=' relative w-80 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl' src='/images/services/firealarms/SpecialOfferFASWarehouse.png' />
                        </div>
            ...
            <Modal
                ...
                <div className='grid sm:grid-cols-2 gap-20  py-32 sm:px-10 px-3 text-justify'>
                    ...
                    <div>
                        <div>
                        Fire alarms in warehouses are critical safety systems designed to protect large storage spaces, inventory, and personnel from fire risks. These systems use a combination of smoke detectors, heat sensors, and manual call points to quickly detect smoke, heat, or flames in expansive areas with high ceilings and varied storage materials. Upon detection, the alarm system triggers an audible alert and flashing lights, ensuring that all personnel are promptly notified and can evacuate safely. Many warehouse fire alarms also integrate with sprinkler systems and remote monitoring for rapid response. Regular inspections and maintenance are crucial to keep these systems effective and compliant with safety regulations.                        
...
<div className="grid sm:grid-cols-2 gap-1 pt-10">
    <div className="grid gap-1">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse7.png" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse2.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse3.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse4.png" alt="" />
        </div> 

    </div>
    <div className="grid gap-1">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse1.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse5.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/firealarms/Warehouse6.png" alt="" />
        </div> 
    </div>
