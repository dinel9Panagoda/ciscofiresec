    ...
    return (
        ...
        <section className=''>
          ...
          <source src="ressources/cooking.mp4" type="video/mp4" />
            ...
            <div className='bg-ackeyfob_banner grid md:grid-cols-3 h-screen'>
                <div className='my-auto ml-10 w-full col-span-2'>
                    ...
                    <h1 className='md:text-7xl sm:text-5xl text-3xl '>
                        <span className='Wittgenstein drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-blue font-black'>Key Fobs<span className='text-white font-bold'> for Access Control</span></span> 
                    </h1>
                </div>
                ...
                <div className='md:grid md:justify-items-stretch'>
                    ...
                    <div className=' relative w-80 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl' src='/images/services/accesscontrol/SpecialOfferACKeyfob.jpg' />
                        </div>
            ...
            <Modal
                ...
                <div className='grid sm:grid-cols-2 gap-20  py-32 sm:px-10 px-3 text-justify'>
                    ...
                    <div>
                        <div>
                        Key fobs are compact, wireless devices used for access control, providing a secure and convenient way to manage entry to buildings or restricted areas. Equipped with unique electronic credentials, key fobs communicate with readers installed at entry points to authenticate users and grant access. Their small size and ease of use make them ideal for carrying on a keyring, allowing quick and contactless access without the need for physical keys or codes. Key fobs are widely used in residential complexes, offices, and other facilities where streamlined, secure access is a priority.
                    </div>
