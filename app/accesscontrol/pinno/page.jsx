    ...
    return (
        ...
        <section className=''>
          ...
          <source src="ressources/cooking.mp4" type="video/mp4" />
            ...
            <div className='bg-acpinno_banner grid md:grid-cols-3 h-screen'>
                <div className='my-auto ml-10 w-full col-span-2'>
                    ...
                    <h1 className='md:text-7xl sm:text-5xl text-3xl '>
                        <span className='Wittgenstein drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-blue font-black'>Pin No<span className='text-white font-bold'> for Access Control</span></span> 
                    </h1>
                </div>
                ...
                <div className='md:grid md:justify-items-stretch'>
                    ...
                    <div className=' relative w-80 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl' src='/images/services/accesscontrol/SpecialOfferACPin.jpg' />
                        </div>
            ...
            <Modal
                ...
                <div className='grid sm:grid-cols-2 gap-20  py-32 sm:px-10 px-3 text-justify'>
                    ...
                    <div>
                        <div>
                        A Personal Identification Number (PIN) for access control is a secure method that uses a unique numeric code to grant or restrict entry to authorized individuals. This system requires users to enter a PIN on a keypad or digital interface to unlock doors or access restricted areas. It is a straightforward and cost-effective solution that enhances security by ensuring that only those with the correct code can gain access. PIN-based access control is ideal for offices, residential buildings, and facilities where simplicity and affordability are key.                        </div>
...
<div className="pt-10">
    <div className="">
        ...
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/PinNo2.jpeg" alt="" />
        </div>
