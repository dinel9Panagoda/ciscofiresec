...
const FaceRecognition = () => {
    ...
    return (
        ...
        <section className=''>
            <div className='bg-acfacerecog_banner grid md:grid-cols-3 h-screen'>
                <div className='my-auto ml-10 w-full col-span-2'>
                    ...
                    <h1 className='md:text-7xl sm:text-5xl text-3xl '>
                        <span className='Wittgenstein drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-green font-black'>Face Recognition <span className='text-blue font-bold'>for Access Control</span></span> 
                    </h1>
                </div>
                ...
                <div className='md:grid md:justify-items-stretch'>
                    ...
                    <div className=' relative w-80 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl' src='/images/services/accesscontrol/SpecialOfferACFacerecog.jpg' />
                        </div>
...
<div className="grid sm:grid-cols-2 gap-1 pt-10">
    <div className="grid gap-1">
        ...
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec2.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec3.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec4.jpeg" alt="" />
        </div> 

    </div>
    <div className="grid gap-1">
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec1.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec5.jpeg" alt="" />
        </div>
        <div>
            <img className="h-auto max-w-full rounded-lg" src="/images/services/accesscontrol/FaceRec7.jpeg" alt="" />
        </div>
    </div>
