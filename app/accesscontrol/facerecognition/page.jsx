    ...
    return (
        <section className=''>
            ...
            <div className=' relative bg-grey sm:py-32 py-20 sm:pl-10 pl-5'>
                ...
                <span className='drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Face Recognition for Access Control</span>
            </h1>
            </div>
            ...
            <h1 className='bg-grey sm:py-32 py-20 sm:pl-10 pl-5 sm:text-5xl text-3xl Wittgenstein text-white font-bold'>
                <span className='drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Fire Alarms in FaceRecognition:</span> Ensuring Safety for All
            </h1> */}
