...
const postData: DataType[] = [
    {
        imgSrc: '/images/services/cctv/CCTV1.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV2.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV3.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV4.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV5.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV6.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV7.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV8.jpeg'
    },
    {
        imgSrc: '/images/services/cctv/CCTV9.jpeg'
    }
]
...
return (
    <section className=''>
        ...
        {/* <div className=''> */}
        <div className='mb-32'>
            <img className='w-full' src='/images/services/cctv/CCTVMainBanner.png' />

        </div>

        <div className='grid sm:grid-cols-2 gap-7 px-10 max-w-7xl mx-auto'>
            <div>
                <img src='/images/services/cctv/StreetCCTV.jpeg' alt="cctv" className="inline-block rounded-3xl w-full"  />
            </div>
            <div className='text-justify'>
                <img className='inline-block w-auto' src='/images/services/cctv/CCTV.GIF' /><br />
                ...
                <div className='specialOfferSideBar'>
                    ...
                    <div className=' relative w-40 h-auto bg-blue rounded-3xl drop-shadow-[0_15px_15px_rgba(0,0,0,0.8)]'>
                        <span className="relative absolute top-1 left-1 flex h-10 w-10">
                            ...
                            <img className='w-80 rounded-3xl bg-white p-3' src='/images/services/cctv/SpecialOfferCCTV.gif' />
                        </div>
    ...
    <RecentWork />               
     <Modal
                    ...
                    >
                        ...
                        <div className='grid md:grid-cols-2'>
                            ...
                            <div onClick={handleClose} className='absolute top-5 right-5 text-white font-bold cursor-pointer'>X</div>
                                ...
                                <img src='/images/services/cctv/SpecialOfferCCTV.gif' className='w-20' />
                                </div>
                                <h1 className='uppercase font-black text-3xl py-10 text-white'>Special Offer!</h1>

                                <p className=''><span className='font-bold bg-lightblue px-5 py-1 rounded-full border-2 border-navyblue text-navyblue text-sm'>Stay Safe & Save Big!</span> <br/> <br/> <span className=' text-white px-5'>Limited Time Discounts on Essential CCTV Equipment!</span></p>
        ...
        <h6 className='text-red text-center pb-5 font-bold text-3xl'>Recent CCTV Units We Did For Our Clients...</h6>
