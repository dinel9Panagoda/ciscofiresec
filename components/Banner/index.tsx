...
const Banner = () => {
    return (
        <div className="">
            ...
            <div className='centered m-auto left-0 right-0 top-0 bottom-0 2xl-72 xl:p-32 lg:p-12 md:p-10 p-5 bg-darkestgrey sm:py-32 py-20'>
...
<a href="/firealarms">
        <div className="bg-white px-1 py-1 shadow-lg rounded-2xl lg:h-56 h-22">
...
<a href="/slidingswingdoors">
        ...
        <div className="bg-grey lg:h-14 h-10 rounded-full mt-1 flex items-center justify-center text-center">
...
<a href="/networkingwiring">
        ...
        <div className="bg-grey lg:h-14 h-10 rounded-full mt-1 flex items-center justify-center text-center">
            <h4 className='lg:text-lg sm:text-xs text-xss font-semibold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]'>Networking/ Wiring Server</h4>
        </div>
        </a>
