...
const FAQ = () => {
    return (
        <div id="faq-section" className='mx-auto max-w-7xl py-24 lg:px-8 rounded-2xl my-16 mb-56 bg-gradient-to-r from-navyblue to-grey'>
                        ...
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left text-2xl font-medium">
                                    <span>What type of fire security services you offer?</span>
                                    <ChevronUpIcon
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    Fire Alarms, Access Control, Video Intercom, CCTV, Intrusion Alarms, Sliding Doors/ Swing Door Operators, Magnetic Locks/ Security Locks and Networking/ Wiring Servers
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
